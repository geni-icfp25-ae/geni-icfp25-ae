...
if [[ "$TYPE" == "link-failure" ]]; then
    ...
    python ${here}/${file_name}.py --m 10 --n 10 --p-init 0.5 --p-edge 0.500000000001 0.500000000002 --p-inner 0.500000000003 0.500000000004 0.500000000005 0.500000000006 | tee ${prefix}.${MODE}.10.10.demo.${LANG}
    generate_prog_cmd="python ${here}/${file_name}.py --m {length} --n {length} --p-init 0.5 --p-edge 0.500000000001 0.500000000002 --p-inner 0.500000000003 0.500000000004 0.500000000005 0.500000000006"
else
